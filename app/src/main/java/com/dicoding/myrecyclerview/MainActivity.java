...
import com.dicoding.myrecyclerview.data.HeroesData;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void startActivity(MainActivity mainActivity, Class<LoginActivity> loginActivityClass) {
        Intent LoginActivity=new Intent(MainActivity.this, com.dicoding.myrecyclerview.LoginActivity.class);
